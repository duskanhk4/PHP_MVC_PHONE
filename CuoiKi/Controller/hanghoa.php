...
switch ($act) {
    ...
    case 'hanghoa_import':
        ...
        while (($csv = fgetcsv($file_open, 1000, ",")) !== false) {
            ...
            $db = new connect();
            $query = "insert into hanghoa (tenhh, dongia, giamgia, hinh, Nhom, maloai,  soluotxem, ngaylap, mota, soluongton,tinhtrang)
            values( '$tenhh', $dongia, $giamgia, '$hinh', $Nhom, $maloai, $soluotxem, '$ngaylap','$mota', $soluongton,0)";
            $db->exec($query);
