<section class="about section" id="about">
    ...
    <div class="about__container container grid">
        ...
        <form action="index.php?action=giohang" method="post" class="about__data detail-data">
            ...
            <span class="section__subtitle detail_subtitle"><?php echo (!$tinhtrang) ? 'inStock' : 'outStock' ?></span>
            ...
            <div class="about__description detail-desc">
                <h4 class="detail-desc-title">Mô tả: </h4>
                <?php echo $mota ?>
            </div>
        ...
        <div class="detail_product-img">
            <img src="<?php echo '../CuoiKi/Content/img/' . $hinh ?>" alt="about image" class="about__img">
            <div class="small_product-img flex">
                ...
                ?>
                    <div class="product_img-item ">
                        <img src="<?php echo '../CuoiKi/Content/img/' . $set['hinh'] ?>" alt="about image">
                    </div>
    ...
    ?>
        <div class="comment_container">
            <div class="comment_content">
                <form class="comment_content" action="index.php?action=sanpham&act=comment&id=<?php echo  $_GET['id'];?>" method="post">
                    <input type="hidden" name="txtmahh" value="" />
                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="" class="comment_avatar">
                    <textarea type="text" name="comment" class="comment" rows="2" cols="70" placeholder="Nhập bình luận của bạn về sản phẩm"></textarea>
                    <button type="submit" class="button comment_btn">Bình luận</button>
                </form>
            </div>
        </div>
    <?php
