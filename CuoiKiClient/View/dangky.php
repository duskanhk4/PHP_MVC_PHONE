            ...
            <h2 class="section__title">Đăng Ký</h3>
                ...
                <div class="container_user">
                    <div class="form-group info-user">
                        ...
                        <input type="text" required="" autofocus="" name="txttenkh" id="name" class="form-control" placeholder="">
                        <!-- <span class="form-message" v-show="invalidName">{{errors.name}}</span> -->
                    </div>
                    <div class="form-group info-user">
                        <label for="name" class="form-label">Địa chỉ:</label>
                        <input type="text" required="" autofocus="" name="txtdiachi" id="name" class="form-control" placeholder="Địa chỉ ">
                        <!-- <span class="form-message" v-show="invalidName">{{errors.name}}</span> -->
                    </div>
                    <div class="form-group info-user">
                        <label for="name" class="form-label">Số Điện Thoại:</label>
                        <input type="text" required="" autofocus="" name="txtsodt" id="name" class="form-control" placeholder="Số điện thoại ">
                        <!-- <span class="form-message" v-show="invalidName">{{errors.name}}</span> -->
                    </div>
                    <div class="form-group info-user">
