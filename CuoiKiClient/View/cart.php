...
<section class=" popular section">
    ...
    ?>
        <form method="post" action="index.php?action=giohang&act=update_item" class="cart-container " id="cart-container">
            <div class="cart-title section__title">Giỏ Hàng của bạn</div>
                ...
                ?>
                    ...
                    <div class="cart-box grid">
                        <a href="index.php?action=sanpham&act=detail&id=<?php echo $item['mahh']; ?>">
                            <img src="<?php echo '../CuoiKi/Content/img/'. $item['hinh'] ?>" alt="" class="cart-img">
                        </a>
            ...
            <div class="total flex ">
                ...
                <p class="total-title popular__name">Tổng:</p>
            ...
            <div class="flex cart-buy">
                <a class="button card-btn" href='index.php?action=order'> Mua Ngay </a>
            </div>
        </form>
